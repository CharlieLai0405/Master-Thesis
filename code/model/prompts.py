...
class_specific_prompts = {
    ...
    'cable': {
        ...
        'abnormal': [
            ...
            'a photo of a cable with damaged outer sheath showing a visible cut.',
            'a photo of a cable with one or more missing wires in the cross-section.',
            'a photo of a cable with a poke hole through the insulation layer.',
            'a photo of a cable with exposed copper due to stripped insulation.',
            'a photo of a cable with combined defects including cuts and missing wires.',
            'a photo of a cable with uneven wire spacing indicating displacement.',
            'a photo of a defective cable with crushed or deformed internal structure.',
        ],
    },
    ...
    'capsule': {
        ...
        'abnormal': [
            ...
            'a photo of a capsule with a split seam where the two halves separate.',
            'a photo of a capsule with smeared or illegible label printing.',
            'a photo of a capsule with dented or crushed surface areas.',
            'a photo of a capsule with discolored patches indicating contamination.',
            'a photo of a defective capsule with multiple surface imperfections.',
        ],
    },
    ...
    'transistor': {
        ...
        'abnormal': [
            'a photo of a transistor with a bent lead angled away from proper position.',
            'a photo of a transistor with a cut or shortened lead.',
            'a photo of a transistor with a damaged or cracked plastic case.',
            'a photo of a transistor that is misplaced or shifted from its correct position.',
            'a photo of a transistor with multiple bent leads in different directions.',
            'a photo of a transistor with melted or heat-damaged case material.',
            'a photo of a transistor with missing lead section from cutting.',
            'a photo of a transistor with leads touching or bridging incorrectly.',
            'a photo of a transistor rotated to wrong orientation on the board.',
            'a photo of a defective transistor with visible physical damage to the body.',
        ],
    },
