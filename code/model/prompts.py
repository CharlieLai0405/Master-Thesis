...
class_specific_prompts = {
    ...
    # ----------------------------------------------------------
    # CABLE — reverted to generic prompts (class-specific caused -3.11 i_AUROC drop)
    # ----------------------------------------------------------
    'cable': {
        'normal': [
            'a photo of a cable.',
            'a photo of the cable.',
            'a photo of a flawless cable.',
            'a photo of the flawless cable.',
            'a photo of a perfect cable.',
            'a photo of the perfect cable.',
            'a photo of an unblemished cable.',
            'a photo of the unblemished cable.',
            'a photo of a cable without flaw.',
            'a photo of the cable without flaw.',
            'a photo of a cable without defect.',
            'a photo of the cable without defect.',
            'a photo of a cable without damage.',
            'a photo of the cable without damage.',
        ],
        'abnormal': [
            ...
            'a photo of a cable with flaw.',
            'a photo of the cable with flaw.',
            'a photo of a cable with defect.',
            'a photo of the cable with defect.',
            'a photo of a cable with damage.',
            'a photo of the cable with damage.',
        ],
    },
    ...
    # ----------------------------------------------------------
    # TRANSISTOR — reverted to generic prompts (class-specific caused -23.48 i_AUROC drop)
    # ----------------------------------------------------------
    'transistor': {
        'normal': [
            'a photo of a transistor.',
            'a photo of the transistor.',
            'a photo of a flawless transistor.',
            'a photo of the flawless transistor.',
            'a photo of a perfect transistor.',
            'a photo of the perfect transistor.',
            'a photo of an unblemished transistor.',
            'a photo of the unblemished transistor.',
            'a photo of a transistor without flaw.',
            'a photo of the transistor without flaw.',
            'a photo of a transistor without defect.',
            'a photo of the transistor without defect.',
            'a photo of a transistor without damage.',
            'a photo of the transistor without damage.',
        ],
        'abnormal': [
            ...
            'a photo of a transistor with flaw.',
            'a photo of the transistor with flaw.',
            'a photo of a transistor with defect.',
            'a photo of the transistor with defect.',
            'a photo of a transistor with damage.',
            'a photo of the transistor with damage.',
        ],
    },
