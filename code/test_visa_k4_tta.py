"""
VisA Best Combo + Multi-scale TTA (5aug)
"""
import os
...
CLASS_CONFIG = {
    'candle':     {'k': 4, 'selection': 'original'},
    'capsules':   {'k': 4, 'selection': 'spread'},
    'cashew':     {'k': 4, 'selection': 'spread'},
    'chewinggum': {'k': 4, 'selection': 'original'},
    'fryum':      {'k': 4, 'selection': 'spread'},
    'macaroni1':  {'k': 4, 'selection': 'spread'},
    'macaroni2':  {'k': 4, 'selection': 'spread'},
    'pcb1':       {'k': 4, 'selection': 'original'},
    'pcb2':       {'k': 4, 'selection': 'spread'},
    'pcb3':       {'k': 4, 'selection': 'spread'},
    'pcb4':       {'k': 4, 'selection': 'spread'},
    'pipe_fryum': {'k': 4, 'selection': 'original'},
}
...
for c_name in CLASS_NAMES:
    ...
    for file_path in tqdm(file_paths[c_name]):
        if FEW_SHOT:
            resp, anomaly_map = predict_with_tta(input_text, file_path, normal_img_path, describles[c_name], c_name)
        else:
